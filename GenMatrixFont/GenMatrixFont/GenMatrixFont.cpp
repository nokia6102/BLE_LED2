...
BEGIN_MESSAGE_MAP(CGenMatrixFontApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CGenMatrixFontApp 建構

CGenMatrixFontApp::CGenMatrixFontApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CGenMatrixFontApp 物件

CGenMatrixFontApp theApp;


// CGenMatrixFontApp 初始設定

BOOL CGenMatrixFontApp::InitInstance()
{
